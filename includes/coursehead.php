        ...
        <nav class="navbar navbar-expand-lg">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <div class="navbar-nav align-items-baseline mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link dsu-link-clr pr-md-4 ds-onclick-e" href="javascript:void(0)"> <img src="<?= base_url('assets/home/')?>img/courses/grid.svg" class="mr-lg-2 img-fluid">Courses
                        </a>
                ...
                <div class="ds-fl-r">
                    <a href="#" class="dsu-pr text-decoration-none">
