<!-- Topbar Start -->
<div class="navbar-custom topnav-navbar topnav-navbar-dark bgcolorset" >
    <div class="container-fluid">
        <!-- LOGO -->
        <a href="<?php echo base_url(''); ?>" class="topnav-logo" style = "min-width: unset;">
            <span class="topnav-logo-lg">
                <img src="<?= base_url('assets/home/')?>img/logo/EarnShalaAdmin.png" alt="" height="60">
                <!-- <p style="color:dodgerblue;font-size:30px!important">EarnShala</p> -->
            </span>
            <span class="topnav-logo-sm">
                <img src="<?= base_url('assets/home/')?>img/logo/EarnShala.png" alt="" height="60">
                <!-- <p style="color:dodgerblue;font-size:30px!important">EarnShala</p> -->
            </span>
        </a>
        ...
        <ul class="list-unstyled topbar-right-menu float-right mb-0">
            <?php if($this->session->userdata('is_instructor') == 1 || $this->session->userdata('admin_login') == 1): ?>
                <li class="dropdown notification-list">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated dropdown-lg p-0 mt-5 border-top-0" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-278px, 70px, 0px);">
                        ...
                        <div class="rounded-top py-3 border-bottom bg-primary bgcolorsetyellow">
            ...
            <?php endif; ?>
            <li class="dropdown notification-list " >
                <a class="nav-link dropdown-toggle nav-user arrow-none mr-0 bgcolorsetyellow" data-toggle="dropdown" id="topbar-userdrop"
