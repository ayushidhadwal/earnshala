...
<?php if ($this->session->flashdata('course_add') != ""):?>
<script type="text/javascript">
  $.NotificationApp.send("<?php echo get_phrase('congratulations'); ?>!", '<?php echo $this->session->flashdata("course_add");?>' ,"top-right","rgba(0,0,0,0.2)","success",50000);
</script>
<?php endif;?>