                                ...
                                <div class="tab-content b-0 mb-0">
                                    <div class="tab-pane" id="basic">
                                        <div class="row justify-content-center">
                                            ...
                                            <div class="form-group row mb-3">
                                                    <label class="col-md-2 col-form-label" for="category_id"><?php echo get_phrase('category'); ?><span class="required">*</span></label>
                                                    <div class="col-md-10">
                                             ...
                                             <div class="form-group row mb-3" >
                                                <label class="col-md-2 col-form-label" for="subcategory">Sub-category<span class="required">*</span></label>
                                                <div class="col-md-10">
                                                    <select class="form-control" name="sub_category_id" id="subcategory_id" required >
                                                    </select>
                                                </div>
                                            </div>

                                            <div class="form-group row mb-3" id="childcategoryshow">
