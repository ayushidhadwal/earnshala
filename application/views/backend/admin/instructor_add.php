    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <form class="required-form" action="<?php echo site_url('admin/instructors/add'); ?>"
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="form-group row mb-3">
                                            <div class="col-md-12 text-right mb-3">
                                                <button class="btn btn-default btn-sm text-white add-more-quli">Add more
                                                    qualifications
                                                </button>
                                            </div>
                                            <div class="col-md-12 append-quli-here">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12 text-right mb-3">
                                                        <button class="btn btn-danger btn-sm text-white delete-quli"
                                                                style="background-color: #fa5c7c !important;">Delete
                                                        </button>
                                                    </div>
                                                    <label class="col-md-3 col-form-label"
                                                           for=""><?php echo get_phrase('Education Qualifications'); ?></label>
                                                    <div class="col-md-9">
                                                        <textarea name="edu_qulification[]"
                                                                  class="form-control summernote-basic"></textarea>
                                                    </div>

                                                    <label class="col-md-3 col-form-label mt-3"
                                                           for=""><?php echo get_phrase('Education Qualification Certificate'); ?>
                                                        <small style="color:red">Supported Files (jpg | png | jpeg | pdf | doc)</small>
                                                    </label>
                            ...
                            <div class="tab-pane" id="pricing">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group row mb-3">
                                            <label class="col-md-3 col-form-label"
                                                   for="facebook_link">Half Hour Price<span class="required">*</span></label>
                                            <div class="col-md-9">
                                        ...
                                        <div class="form-group row mb-3">
                                            <label class="col-md-3 col-form-label"
                                                   for="facebook_link">One Hour Price<span
                                                        class="required">*</span></label>
                                            <div class="col-md-9">
