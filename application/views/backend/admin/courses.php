        ...
        <div class="card">
            ...
            <div class="table-responsive-sm mt-4">
                <?php if (count($courses) > 0): ?>
                    <table id="datatable-buttons" class="table table-striped nowrap text-center" data-page-length='25'>
                        <thead>
                            <tr>
                                <th>#</th>
                                    ...
                                    <td>
                                        <div class="dropright dropright">
                                          ...
                                          <ul class="dropdown-menu">
                                            <?php if ($course['is_free_course'] != 1) {?>
                                                <li><a class="dropdown-item" href="<?php echo site_url('admin/enable_partial_payment/'.$course['id']); ?>"><?php echo get_phrase('enable_partial_payments');?></a></li>   
                                            <?php } ?>
                                              ...
                                              <li><a class="dropdown-item" href="<?php echo site_url('admin/course_actions/reviews/'.$course['id']); ?>"><?php echo get_phrase('reviews'); ?></a></li>
                                          </ul>
                                      </div>
                                    </td>
                                </tr>
