                                ...
                                <td>
                                    <div class="dropright dropright">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item" href="<?php echo site_url('admin/live_class?instructor_id='.$user['id']) ?>">View Live Class</a></li>
                                            <li><a class="dropdown-item" href="<?php echo site_url('admin/counselling_session?instructor_id='.$user['id']) ?>">View Counselling Sessions</a></li>
