...
?>
<form action="<?php echo site_url('admin/quiz_questions_new/'.$param3.'/edit/'.$param2); ?>" method="post" id = 'mcq_form'>
    ...
    <div class="form-group" id='multiple_choice_question'>
        ...
        <div class="input-group">
            <input type="hidden" class="form-control" name="number_of_options" id="number_of_options" data-validate="required" data-message-required="Value Required" min="0" max="4" value="4">
            ...
            <div class="input-group">
                ...
                <div class="input-group-append">
                    <span class="input-group-text">
                        <input type='radio' name = "correct_answers[]" value = <?php echo ($i+1); ?> <?= ($i+1 == $correct_answers) ? "checked" : ""?> >
                    </span>
                </div>
            </div>
        </div>
...
$('#submitButton').click( function(event) {
    $.ajax({
        url: '<?php echo site_url('admin/quiz_questions_new/'.$param3.'/edit/'.$param2); ?>',
        type: 'post',
    ...
    showLargeModal('<?php echo site_url('modal/popup/quiz_questions_new/'.$param3); ?>', '<?php echo get_phrase('manage_quiz_questions'); ?>');
});
</script>
