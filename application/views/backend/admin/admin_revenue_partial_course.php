        ...
        <div class="card">
            <div class="card-body">
                <h4 class="page-title"><i
                            class="mdi mdi-apple-keyboard-command title_icon"></i> <?php echo get_phrase('admin_revenue_partial_course'); ?>
                </h4>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
...
<div class="row">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <h4 class="mb-3 header-title"><?php echo get_phrase('admin_revenue_partial_course'); ?></h4>
                <div class="row justify-content-md-center">
                    <div class="col-xl-6">
                        <form class="form-inline"
                              action="<?php echo site_url('admin/admin_revenue_partial_course/filter_by_date_range') ?>" method="get">
                            <div class="col-xl-10">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-centered mb-0 text-center">
                        ...
                        foreach ($payment_history as $key => $getPayment):
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php foreach(json_decode($getPayment['installments']) as $iskey => $ins){
                                        if (count(json_decode($getPayment['installments'])) != $iskey+1) {
                                            $separator = ', ';
                                        }else{
                                            $separator = '';
                                        }
