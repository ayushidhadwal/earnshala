        ...
        <div class="card">
            <div class="card-body">
                ...
                <ul class="nav nav-tabs nav-bordered mb-3">
                    ...
                    <li class="nav-item">
                        <a href="<?php echo site_url('admin/instructor_payout_live'); ?>" class="nav-link">
                            <i class="mdi mdi-home-variant d-lg-none d-block mr-1"></i>
                        ...
                        <div class="table-responsive-sm mt-4">
                            <table id="completed-payout" class="table table-striped table-centered mb-0">
                                ...
                                foreach ($completed_counselling_payouts as $key => $getData) :
                                    ...
                                    $instructorSum = $this->db->get_where('payment', ['instructor_id' => $getData['instructor_id'], 'course_type' => 'counselling', 'isPaid' => 1])->result();
                                    $total = 0;
