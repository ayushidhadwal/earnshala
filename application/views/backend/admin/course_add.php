                                ...
                                <div class="tab-content b-0 mb-0">
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input type="number" class="form-control" id="duration"
                                                               name="duration" placeholder="Course Duration" required>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-xl-8">
                                                <div class="form-group row mb-3">
                                                    <div class="offset-md-2 col-md-10">
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input"
                                                                   name="is_free_course" id="is_free_course" value="1" checked
                                                ...
                                                <div class="paid-course-stuffs" style="display: none;">
                                                    <div class="form-group row mb-3">
                                                        <label class="col-md-2 col-form-label"
                                    ...
                                    <div class="tab-pane" id="media">
                                        <div class="row justify-content-center">
                                            ...
                                            <!--                                                        --><?php //echo get_phrase('course_overview_provider'); ?>
                                            <!--                                                    </label>-->
                                            <!--                                                    <div class="col-md-10">-->
                                            <!--                                                        <select class="form-control select2" data-toggle="select2"-->
                                            ...
                                            <?php //echo get_phrase('course_overview_url'); ?><!--</label>-->
                                            <!--                                                    <div class="col-md-10">-->
                                            <!--                                                        <input type="text" class="form-control"-->
