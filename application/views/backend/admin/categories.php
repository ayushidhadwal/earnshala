                     ...
                     <?php foreach ($sub_categories as $sub_category): ?>
                        <li class="list-group-item on-hover-action" id = "<?php echo $sub_category['id']; ?>">
                            ...
                            <span class="category-action" id = 'category-edit-btn-<?php echo $sub_category['id']; ?>' style="float: right; display: none; height: 20px;">
                             ...
                             <span class="category-action" id = 'category-add-btn-<?php echo $sub_category['id']; ?>' style="float: right; display: none; height: 20px;">
                                <a href="<?php echo site_url('admin/child_categories/view/'.$sub_category['id']); ?>" class="action-icon"> <i class="mdi mdi-plus" style="font-size: 18px;"></i></a>
                            </span>
