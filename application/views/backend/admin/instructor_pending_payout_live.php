            ...
            <div class="card-body">
                ...
                <div class="tab-content">
                    ...
                    <ul class="nav nav-tabs nav-bordered mb-3">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo site_url('admin/pending_payout_live_class'); ?>" class="nav-link active">
                                <i class="mdi mdi-home-variant d-lg-none d-block mr-1"></i>
                        ...
                        <table id="completed-payout" class="table table-striped table-centered mb-0 text-center">
                                ...
                                foreach ($pending_counselling_payouts as $key => $getData) :
                                    ...
                                    $instructorSum = $this->db->get_where('payment', ['instructor_id' => $getData['instructor_id'], 'course_type' => 'live', 'isPaid' => 0])->result();
                                    $total = 0;
