    ...
    <div class="row">
      <div class="col-md-6">
        <p class="copyright-text">
          <a href="<?= base_url('') ?>"><img src="<?= base_url('assets/home/')?>img/courses/lyvyo-blue.png" alt="" class="d-inline-block" width="110"></a>
        </p>
      </div>
      <div class="col-md-6">
        <ul class="nav justify-content-md-end footer-menu">
          <li class="nav-item">
            <a class="nav-link" href="<?php echo site_url('about-us'); ?>"><?php echo site_phrase('about'); ?></a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?php echo site_url('privacy-policy'); ?>"><?php echo site_phrase('privacy_policy'); ?></a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?php echo site_url('terms-of-use'); ?>"><?php echo site_phrase('terms_and_condition'); ?></a>
          </li>
