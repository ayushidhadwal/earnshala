        ...
        <form action="<?php echo site_url('home/sections/add/'.$course_id); ?>" id = "ajaxFormForAdding" onsubmit="addSection(event)" method="post" enctype="multipart/form-data">
            <div class="basic-group">
                <div class="form-group">
                    <label for="title"><?php echo site_phrase('title'); ?>:</label>
                    <input type="text" class="form-control" name = "title" id="title" placeholder="<?php echo site_phrase('title'); ?>" required>
                </div>
            </div>
            <div class="content-update-box">
                <button type="submit" name = "submit" class="btn col-4"><?php echo site_phrase('add_section'); ?></button>
            </div>
        </form>
    </div>
    <div class="content-box" id = "edit_form_area" style="display: none;">
        <form action="" id = "ajaxFormForUpdating" onsubmit="updateSection(event)" method="post" enctype="multipart/form-data">
            <div class="basic-group">
                <div class="form-group">
                    <label for="title"><?php echo site_phrase('title'); ?>:</label>
                    <input type="text" class="form-control" name = "title" id="section_title_for_editing" placeholder="<?php echo site_phrase('title'); ?>" required>
                </div>
            </div>
            <div class="content-update-box">
                <button type="submit" name = "submit" class="btn col-4"><?php echo site_phrase('update_section'); ?></button>
                <button type="button" name = "reset" class="btn col-4" onclick="resetForm()"><?php echo site_phrase('reset'); ?></button>
            </div>
        </form>
