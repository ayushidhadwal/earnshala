            ...
            <div class="col">
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo site_url('home/dashboard'); ?>"><?php echo site_phrase('dashboard'); ?></a></li>
                        <li class="breadcrumb-item active"><a href="#"><?php echo site_phrase('edit_course_detail'); ?></a></li>
                    </ol>
                </nav>
                <h1 class="page-title"><?php echo $page_title .' - '.$course_details['title'];; ?></h1>
                <ul>
                    <li class="<?php if($type == 'edit_course') echo "active"; ?>"><a href="<?php echo site_url('home/edit_course/'.$course_id.'/edit_course'); ?>"><?php echo site_phrase('edit_basic_informations'); ?></a></li>
                    <li class="<?php if($type == 'manage_section') echo "active"; ?>"><a href="<?php echo site_url('home/edit_course/'.$course_id.'/manage_section'); ?>"><?php echo site_phrase('manage_section'); ?></a></li>
                    <li class="<?php if($type == 'manage_lesson') echo "active"; ?>"><a href="<?php echo site_url('home/edit_course/'.$course_id.'/manage_lesson'); ?>"><?php echo site_phrase('manage_lesson'); ?></a></li>
                </ul>
            </div>
        </div>
    </div>
              ...
              <div class="content-box" id = "lesson_adding_form_area">
                  <form role="form" class="form-horizontal form-groups-bordered" action="<?php echo site_url('home/manage_lessons/edit/'.$course_id.'/'.$lesson_id); ?>" method="post" enctype="multipart/form-data">
                      <div class="form-group">
                          <label class="col-lg-3 control-label"><?php echo site_phrase('title'); ?></label>
                          <div class="col-lg-12">
                      ...
                      <div class="form-group">
                          <label class="col-sm-3 control-label"><?php echo site_phrase('section'); ?></label>
                          <div class="col-sm-12">
                              <select class="form-control" id="section_id" name="section_id" required>
                                <option value=""><?php echo site_phrase('select_a_section'); ?></option>
                      ...
                      <div class="form-group">
                          <label class="col-sm-3 control-label"><?php echo site_phrase('lesson_type'); ?></label>
                          <div class="col-sm-12">
                              <select class="form-control" id="lesson_type" name="lesson_type" required onchange="show_lesson_type_form(this.value)">
                                <option value=""><?php echo site_phrase('select_type_of_lesson'); ?></option>
                                <option value="video-url" <?php if($lesson_details['attachment_type'] == 'url') echo 'selected'; ?>><?php echo site_phrase('video_url'); ?></option>
                                <option value="other-txt" <?php if($lesson_details['attachment_type'] == 'txt') echo 'selected'; ?>><?php echo site_phrase('text_file'); ?></option>
                                <option value="other-pdf" <?php if($lesson_details['attachment_type'] == 'pdf') echo 'selected'; ?>><?php echo site_phrase('pdf_file'); ?></option>
                                <option value="other-doc" <?php if($lesson_details['attachment_type'] == 'doc') echo 'selected'; ?>><?php echo site_phrase('document_file'); ?></option>
                                <option value="other-img" <?php if($lesson_details['attachment_type'] == 'img') echo 'selected'; ?>><?php echo site_phrase('image_file'); ?></option>
                              </select>
                          </div>
                      </div>
                      ...
                      <div class="" id="video" <?php if($lesson_details['lesson_type'] != 'video'):?> style="display: none;" <?php endif; ?>>
                        <div class="form-group">
                            <label class="col-sm-3 control-label"><?php echo site_phrase('provider'); ?></label>
                            <div class="col-sm-12">
                              <select class="form-control" id="lesson_provider" name="lesson_provider" onchange="check_video_provider(this.value)">
                                <option value=""><?php echo site_phrase('select_lesson_provider'); ?></option>
                                <option value="youtube" <?php if(strtolower($lesson_details['video_type']) == 'youtube') echo 'selected'; ?>><?php echo site_phrase('youtube'); ?></option>
                                <option value="vimeo" <?php if(strtolower($lesson_details['video_type']) == 'vimeo') echo 'selected'; ?>><?php echo site_phrase('vimeo'); ?></option>
                        ...
                        <div class="" id = "youtube_vimeo" <?php if(strtolower($lesson_details['video_type']) == 'vimeo' || strtolower($lesson_details['video_type']) == 'youtube'):?>  <?php else: ?> style="display: none;" <?php endif; ?>>
                          <div class="form-group">
                              <label class="col-sm-3 control-label"><?php echo site_phrase('video_url'); ?></label>
                              <div class="col-sm-12">
                                  ...
                                  <label class="form-label" id = "invalid_url" style ="margin-top: 4px; color: red; display: none;"><?php echo site_phrase('invalid_url').'. '.site_phrase('your_video_source_has_to_be_either_youtube_or_vimeo'); ?></label>
                                  <label class="form-label" id = "preloader" style ="margin-top: 4px; color: #000; display: none;"><i class="fas fa-spinner fa-pulse" aria-hidden="true"></i> &nbsp;<?php echo site_phrase('analyzing_given_url').'....'; ?></label>
                              </div>
                          </div>

                          <div class="form-group">
                              <label class="col-sm-3 control-label"><?php echo site_phrase('duration'); ?></label>
                              <div class="col-sm-12">
                      ...
                      <div class="" id = "other" <?php if($lesson_details['lesson_type'] != 'other'):?> style="display: none;" <?php endif; ?>>
                        <div class="form-group">
                            <label class="col-sm-3 control-label"><?php echo site_phrase('attachment'); ?></label>
                            <div class="col-sm-12">
                      ...
                      <div class="form-group">
                          <label class="col-sm-3 control-label"><?php echo site_phrase('thumbnail'); ?></label>
                          <div class="col-sm-12">
                      ...
                      <div class="form-group">
                          <label class="col-sm-3 control-label"><?php echo site_phrase('note'); ?>:</label>
                          <div class="col-sm-12">
                      ...
                      <div class="form-group">
                          <div class="col-sm-offset-3 col-sm-12">
                              <button class = "btn btn-success" type="submit" name="button"><?php echo site_phrase('update_lesson'); ?></button>
                              <a href="<?php echo site_url('home/edit_course/'.$course_id.'/manage_lesson') ?>" class = "btn btn-success" name="button" style="color: white;"><?php echo site_phrase('cancel'); ?></a>
                          </div>
                      </div>
                  </form>
              </div>
                  ...
                  <table class="table">
                      <thead>
                        <tr>
                          ...
                          <th><?php echo site_phrase('section'); ?></th>
                          <th><?php echo site_phrase('lesson_type'); ?></th>
                          <th><?php echo site_phrase('action'); ?></th>
                        </tr>
                      </thead>
                      <tbody>
