  ...
  <div class="course-sidebar natural">
    ...
    <div class="course-sidebar-text-box">
      ...
      <?php if(is_purchased($course_details['id'])) :?>
        <div class="dsu-add-to-wishlist mb-2">
          <a class="text-white" href="<?php echo site_url('home/my_courses'); ?>"><?php echo site_phrase('already_purchased'); ?></a>
        </div>
      <?php else: ?>

          <!-- WISHLIST BUTTON -->
          <div class="buy-btns">
              <button class="dsu-add-to-wishlist btn-block <?php echo $this->crud_model->is_added_to_wishlist($course_details['id']) ? 'active' : ''; ?>" type="button" id = "<?php echo $course_details['id']; ?>" onclick="handleAddToWishlist(this)">
                  <?php
        ...
        <?php if ($course_details['is_free_course'] == 1): ?>
          <div class="buy-btns">
            <?php if ($this->session->userdata('user_login') != 1): ?>
              <a href = "#" class="dsu-get-enrolled btn-block" onclick="handleEnrolledButton()"><?php echo site_phrase('get_enrolled'); ?></a>
            <?php else: ?>
