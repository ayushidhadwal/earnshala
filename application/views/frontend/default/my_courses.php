                            ...
                            <div class="course-box">
                                ...
                                <div class="" id = "course_info_view_<?php echo $my_course['course_id'];  ?>">
                                  ...
                                  <div class="row" style="padding: 4px 10px;">
                                      <div class="col-md-6 pr-1 pt-2">
                                          <a href="<?php echo site_url('home/course/'.rawurlencode(slugify($course_details['title'])).'/'.$my_course['course_id']); ?>" class="dsu-course-detail btn-block"><?php echo site_phrase('course_detail'); ?></a>
                                      </div>
                                      <div class="col-md-6 pl-1 pt-2">
                                           <a href="<?php echo site_url('home/lesson/'.rawurlencode(slugify($course_details['title'])).'/'.$my_course['course_id']); ?>" class="dsu-start-lesson btn-block"><?php echo site_phrase('start_lesson'); ?></a>
                                      </div>
                                  </div>
                                </div>
                                ...
                                <div class="course-details" style="display: none; padding-bottom: 10px;" id = "course_rating_view_<?php echo $course_details['id']; ?>">
                                  ...
                                  <?php
                                    ...
                                    if(empty($user_specific_rating))
                                    {
                                      $user_specific_rating['rating'] = 0;
                                      $user_specific_rating['review'] = '';
                                    }
                    							?>
