...
<?php 
     if($subcategory->id == 5)
     {
        $idtitile = "primary-level";
     }
     else if($subcategory->id == 7)
     {
         $idtitile = "secondary-level";
     }
     else if($subcategory->id == 6)
     {
         $idtitile = "high-school-level";
     } 
     else
     {
         $idtitile = "university-level";
     }     
 ?>
<div class="ds-university-level" id="<?= $idtitile ?>">
    <div class="container" >
        <div class="row">
            <div class="col-md-5 pr-md-0 pt-md-5">
                <?php if($subcategory->id == 5){ ?>
                <img class="img-fluid" src="<?= base_url()?>assets/home/img/new-png/pl.png" alt="primary level">
            <?php }
            elseif($subcategory->id == 7){ ?>
                <img class="img-fluid" src="<?= base_url()?>assets/home/img/new-png/sl.png" alt="secondary level">

            <?php }
            elseif($subcategory->id == 6){ ?>
                <img class="img-fluid" src="<?= base_url()?>assets/home/img/new-png/hl/hl.png" alt="high school level">

            <?php }
            else{ ?>
                 <img class="img-fluid" src="<?= base_url()?>assets/home/img/new-png/ul/ul-university.png" alt="university level">

            <?php } ?>
            </div>

            <div class="row pb-4 ds-spl-padding mx-0 mx-md-1">
                <?php foreach($childcat as $key => $val): ?>
               
                <div class="col-md-4 col-6 px-md-0 text-center">
                     <a href="<?= base_url('instructors/'.$val->id)?>" class="text-decoration-none">
                    <img class="w-50 ds-w100p" src="<?php echo base_url('uploads/thumbnails/category_thumbnails/'.$val->thumbnail); ?>" alt="">
                    <p class="ds-clr fdm dsfontp"><?= $val->name ?></p>
                    </a>
                </div>
