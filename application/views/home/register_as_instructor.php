...
<div class="row mx-0 flex-column-reverse flex-lg-row">
    <div class="col-md-12 col-lg-7 pt-4 height-100vh">
        ...
        <h5 class="text-center hr-subHeading">create your account now and start earning</h5>
        <div class="row">
            <div class="col-md-12">
        ...
        <div class="container pt-xl-4 px-5">
            ...
            <div class="row">
                ...
                <div class="col-md-3 pl-md-0 ">
                    <div class="form-group">
                        <select name="language" class="form-control custom-select hr-select-control">
            ...
            <div class="row mt-2">
                ...
                <input type="hidden" name="path" value="register-as-instructor">
        ...
        <div class="pt-xl-5 pt-4">
            <div class="row text-center">
                <div class="col-md-12">
                    ...
                    &nbsp;
                    <a href="<?= base_url('login') ?>"><button class="btn btn-sm hr-btn px-4">LOG IN</button></a>
                </div>
            ...
            <h2 class="text-white text-center aristotelica-text-bold font-weight-bolder py-4 hr-connect-text">Connecting Minds</h2>
        </div>
    </div>
</div>
