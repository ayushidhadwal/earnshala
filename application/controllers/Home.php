...
class Home extends CI_Controller {
    ...
    public function __construct()
    {
        ...
        $this->load->vars(compact('latestcourse'));
    ...
    public function myaccount(){
        echo 'Payment is successfully done.';
    }
    ...
    public function profile($param1 = "") {
        ...
        if ($param1 == 'user_profile') {
           ...
           $page_data['countries'] = $this->lyvyo_model->get_countries()->result();
    ...
    public function update_profile($param1 = "") {
        if ($param1 == 'update_basics') {
            ...
            if (isset($_FILES['user_image']) && $_FILES['user_image']['name'] != "") {
                ...
                if(!empty($this->db->get_where('users', array('id' => $this->session-> userdata('user_id')))->row('image')))
                {
    ...
    public function sign_up() {
        ...
        // $this->load->view('frontend/'.get_frontend_settings('theme').'/index', $page_data);
        $this->load->view('home/register', $page_data);
    }
    ...
    public function getSubChildCatgeory()
    {
        $this->load->model('Lyvyo_model','lyvyo_model');
        $data = $this->lyvyo_model->fetchSubChildCategory($this->input->post('cat'));
        echo json_encode($data);
        exit;
    }

    //live course add view
    public function addLiveClassDateTimeView()
    {
        $this->load->model('Lyvyo_model','lyvyo_model');
        $page_data['page_name'] = 'live_class_time';
    ...
    public function addLiveClassDateTime()
    {
    ...
    public function liveClassList()
    {
        ...
        $page_data['class'] = $this->lyvyo_model->fetchLiveClassListByInstructorId();
